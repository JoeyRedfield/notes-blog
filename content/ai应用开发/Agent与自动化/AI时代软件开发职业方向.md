...
- Agent 工程化方法论（[[Agent与自动化/AI Harness（驾驭层）知识手册|AI Harness]]、[[《12-factor-agents》]]）
...
- [[Agent与自动化/上海十五五规划-AI智能体政策解读]] — 政策背景
- [[Agent与自动化/AI Harness（驾驭层）知识手册]] — Agent 工程化基础
- [[Agent与自动化/AI Agent 自动化任务方案对比]] — 自动化方案选型
