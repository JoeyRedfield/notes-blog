---
tags: [claude-code, hooks, skills, agents, deep-dive]
created: 2026-06-01
raw: "[[raw/I Read the Claude Code Source Code. Here's Everything You Can Configure That the Docs Don't Tell You.]]"
---
...
- [[Claude Code/Claude Code Skills 与 MCP 精华笔记]] — Skills 与 MCP 生态
- [[Claude Code/ECC（Everything Claude Code）知识手册]] — ECC 框架全貌
- [[Claude Code/Claude Code 切换 API、Resume 与缓存命中学习笔记]] — 缓存机制
- [[Agent与自动化/AI Harness（驾驭层）知识手册]] — Agent 工程范式
...
三种记忆层级（user/project/local）本质上是 LLM Wiki 架构在 Agent 层面的工程化实现。理解记忆系统设计是 AI Agent 开发的核心工程问题。详见 [[Agent与自动化/AI时代软件开发职业方向]]。
