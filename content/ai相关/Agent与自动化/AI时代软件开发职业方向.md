...
> [!note]
> 本页现在作为这一组职业路线笔记的**总览页**。
> 如果你只想先抓主结论，先读这页；再按需继续读：
> - [[“人工智能+消费”政策对职业方向的含义]]：为什么最近政策信号会强化这条路线
> - [[政策信号到行动清单：学什么、做什么项目]]：把路线判断落成学习和项目动作

## 本页定位

这页回答的是：**在 AI 时代，软件开发者更值得押注哪两条主线。**
...
- 6 周执行节奏
- 单个项目的实施清单
- 2026 年学习顺序、求职市场和团队组织变化的全部细节

这些内容已经分别下沉到对应延伸页，避免三篇笔记重复写同一套结论。

如果要继续往外扩：

- [[2026年学编程路线与AgenticEngineering|2026年学编程路线与Agentic Engineering]]：从学习顺序看，能力应该怎么补
- [[2026年技术求职路线图与AI技能选择——Meta工程师视角]]：从求职市场看，作品集和时间分配怎么调
- [[AI原生工程团队运作实践]]：从团队组织看，流程和角色怎么变
- [[Agentic Coding 与专业知识的持久回报]]：从官方研究看，为什么领域知识会成为乘数
...
- [[“人工智能+消费”政策对职业方向的含义]] — 这条路线为什么会被最近国家级场景政策进一步强化
- [[国家“人工智能+消费”与上海AI智能体政策对照]] — 地方与国家两个政策口径的差异与互补
- [[政策信号到行动清单：学什么、做什么项目]] — 把总路线继续收束成学习顺序、项目选择与 6 周执行清单
