...
- [[01-生成式软件工程开篇——欢迎来到未来（NJU）]] — `[社区快照]` 南京大学生成式软件工程第一课：从 Agent 单任务能力走向意图、规约、实现和长期维护
- [[AI编码实践/提示词工程——从 Prompt 到 Context Engineering（NJU）]] — `[社区快照]` 南京大学生成式软件工程第二课：完整上下文、verifier、注意力污染与长期软件演化
