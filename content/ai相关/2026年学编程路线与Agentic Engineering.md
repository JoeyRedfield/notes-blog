...
- [[AI Harness（驾驭层）知识手册]] — Agent 工程第三波范式的完整理论框架
- [[AI时代软件开发职业方向]] — AI 时代的两个务实开发方向
- [[AI Agent 自动化任务方案对比]] — Cron vs Codex vs Claude Routines
- [[ECC（Everything Claude Code）知识手册]] — Claude Code 全面实践知识
- [[Claude Code CLI 新会话检查清单]] — MCP 与 Hooks 生效验证
