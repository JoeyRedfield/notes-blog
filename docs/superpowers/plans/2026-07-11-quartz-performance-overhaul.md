...
test("uses deterministic webp names", () => {
  assert.equal(responsivePath("assets/photo.png", 720), "assets/photo.png.w720.webp")
})
```
...
- [x] **Step 1: 写出标签总览、KaTeX 和 OG 输入测试**
